# 🚀 Proyectos 2026 - Jóvenes + IA

Bienvenido al repositorio de proyectos del taller **"Jóvenes Emprendedores con IA"**.
...
La idea es que antes de ponerse a programar, los estudiantes puedan **visualizar, organizar y planificar** su proyecto usando una estructura clara.
...
- **Estudiantes** que quieran aprender a crear apps con IA desde cero.
- **Docentes** que busquen material listo para talleres de tecnología.
- **Jóvenes emprendedores** que quieran convertir una idea en un prototipo funcional.

No hace falta saber programar. Las guías están escritas en un lenguaje simple, con pasos claros y ejemplos concretos.
...
| **Vercel** | [vercel.com](https://vercel.com) | Publicar la app gratis |
| **PWABuilder** | [pwabuilder.com](https://pwabuilder.com) | Convertir la app en APK para celular |

**Solo necesitás cuentas gratuitas en Replit, Hugging Face y (a veces) Supabase.**
...
Antes de escribir una sola línea de código, es importante:

- **Entender el problema** que querés resolver
- **Conocer a tus usuarios** y qué necesitan
...
**Unificamos criterios** para que todos los proyectos sigan la misma estructura.

---

## 🤝 Contribuciones

Estos proyectos están **en desarrollo**. Si sos estudiante o docente y querés:

- Reportar un error en una guía
- Sugerir un nuevo proyecto
- Mejorar los prompts o los pasos

Podés abrir un **Issue** o un **Pull Request** en este repositorio. Todas las ideas son bienvenidas.

---

## 📄 Licencia

MIT - Podés usar, modificar y compartir estas guías libremente.

---

## 👥 Autores

Proyectos desarrollados por jóvenes del taller **"Jóvenes Emprendedores con IA"** - [Nombre del curso/institución]

---

## 🌟 ¿Te resultó útil este repositorio?

Si estas guías te ayudaron a crear tu primera app con IA, contanos tu experiencia. Cada proyecto que nace de acá es un logro compartido.

🚀 **A crear, que el futuro se construye hoy.**
